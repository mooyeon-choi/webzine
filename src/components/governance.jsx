    ...
    return (
      <article className="modal" onClick={this.handleCloseModal} onScroll={this.handleScroll}>
        ...
        <h1 className="modal-header-subtitle">ESG와 관련해 SK 그룹이 해 온/해 나갈 것들</h1>
          ...
          <img className="center-img" src="https://github.com/mooyeon-choi/webzine/blob/main/src/images/governance01.png?raw=true" alt="re100"/>
          <h2 className="modal-text-title">지배구조 공시</h2>
          <p className="modal-text"> 지주회사인 SK주식회사는 ‘기업지배구조헌장’을 제정하여 주주의 권리, 이사회와 감사위원회의 권한과 책임 등 지배구조에 대한 정보를 제공합니다. 더 나아가 위원회 활동현황 및 ESG 등급 정보를 제공하며 공정한 경영을 추구합니다.</p>
