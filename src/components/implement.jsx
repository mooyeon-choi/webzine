    ...
    return (
      <article className="modal" onClick={this.handleCloseModal} onScroll={this.handleScroll}>
        ...
        <h2 className="modal-header-subtitle">구성원 차원에서 할 수 있는 작은 아이디어들</h2>
          ...
          <p className="modal-text">24일 오전 11시 충북 청주 시 상당구 용암1동 행정복지센터 지하주차장에서 SK하이닉스와 함께 김장 나눔 행사를 진행했다.
...
특히 이번 행복김장나눔은 SK하이닉스에서 김장비용을 지정기탁하고 한범덕 청주시장을 비롯한 청주시 자원봉사자와 SK하이닉스 문유진 부사장과 임직원 등 총 50여 명이 함께했다.
          ...
          <p className="modal-text">이날 봉사활동에 참가한 SK건설 신입사원 35명은 연탄 1200장을 부암동 일대 저소득층 4가구에 직접 배달하고 인근 지역 환경 정화 활동을 실시했다.
...
<h2 className="modal-text-title">'인형에 마음 담아' SK이노, 취약계층 지원 봉사활동 전개</h2>
          <p className="modal-text">SK이노베이션가 취약계층의 ‘심리방역’ 지원 차원에서 직접 제작한 인형과 손편지를 선물하는 ‘코로나19 극복 마음방역 으랏차차 언택트 자원봉사’를 진행했다고 22일 밝혔다.
