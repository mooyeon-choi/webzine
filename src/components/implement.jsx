  ...
  render() {
    return (
      <article className="modal" onClick={this.handleCloseModal} onScroll={this.handleScroll}>
        ...
        <h2 className="modal-header-subtitle">구성원 차원에서 할 수 있는 ESG 활동</h2>
          ...
          <h2 className="modal-text-title">SK하이닉스와 청주시가 함께하는 김장 나눔 행사</h2>
          <img className="center-img" src="https://github.com/mooyeon-choi/webzine/blob/main/src/images/kimch01.jpg?raw=true" alt="esg"/>
          <p className="modal-text">충북 청주 시 상당구 용암1동 행정복지센터 지하주차장에서 SK하이닉스와 함께 김장 나눔 행사를 진행했습니다. 이번 김장 나눔 행사로 김치 6300kg을 담가 지역 내 취약계층 630가구의 겨울나기를 지원했습니다. 특히 이번 행복김장나눔은 SK하이닉스에서 김장비용을 지정기탁하고 한범덕 청주시장을 비롯한 청주시 자원봉사자와 SK하이닉스 문유진 부사장과 임직원 등 총 50여 명이 함께했습니다.</p>
          ...
          <p className="modal-text">SK건설 신입사원 35명은 연탄 1200장을 부암동 일대 저소득층 4가구에 직접 배달하고 인근 지역 환경 정화 활동을 실시했습니다. SK건설은 사회적 책임을 다하고 나눔을 실천하는 기업문화를 몸소 체험할 수 있도록 지난 2005년부터 신입사원 교육 필수과정으로 사회공헌 활동을 실시해 오고 있습니다.</p>
          <h2 className="modal-text-title">SK이노베이션 취약계층 지원 봉사활동 전개</h2>
          ...
          <p className="modal-text">SK이노베이션가 취약계층의 ‘심리방역’ 지원 차원에서 직접 제작한 인형과 손편지를 선물하는 ‘코로나19 극복 마음방역 으랏차차 언택트 자원봉사’를 진행했습니다. 인형은 폐플라스틱 재활용솜을 활용해 만들었으며, 30초짜리 음성 녹음도 담아 취약계층에 응원 메시지를 전했습니다. 지난달까지 두 달 간 진행된 이번 봉사활동에는 SK이노베이션 계열 임직원 2,500여명이 참여했습니다. 인형과 손편지는 마스크 등 생활방역 용품과 함께 독거노인 1,500명, 발달장애인 1,000명 등에게 전달됐습니다.</p>
