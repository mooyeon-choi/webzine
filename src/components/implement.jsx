    ...
    return (
      <article className="modal" onClick={this.handleCloseModal} onScroll={this.handleScroll}>
        ...
        <h2 className="modal-header-subtitle">구성원 차원에서 할 수 있는 ESG 활동</h2>
          ...
          <p className="modal-text">충북 청주 시 상당구 용암1동 행정복지센터 지하주차장에서 SK하이닉스와 함께 김장 나눔 행사를 진행했습니다. 이번 김장 나눔 행사로 김치 6300kg을 담가 지역 내 취약계층 630가구의 겨울나기를 지원합니다. 특히 이번 행복김장나눔은 SK하이닉스에서 김장비용을 지정기탁하고 한범덕 청주시장을 비롯한 청주시 자원봉사자와 SK하이닉스 문유진 부사장과 임직원 등 총 50여 명이 함께했습니다.</p>
          ...
          <p className="modal-text">SK건설 신입사원 35명은 연탄 1200장을 부암동 일대 저소득층 4가구에 직접 배달하고 인근 지역 환경 정화 활동을 실시했다. SK건설은 사회적 책임을 다하고 나눔을 실천하는 기업문화를 몸소 체험할 수 있도록 지난 2005년부터 신입사원 교육 필수과정으로 사회공헌 활동을 실시해 오고 있다.</p>
